...
// Mock data para timeline de trabajador
const mockTimeline = [
  {
    id: 1,
    ...
    description: 'Caja Premium entregada - Código QR: 4567',
    guard: 'Pedro Soto',
    status: 'completed',
  },
  {
    ...
    type: 'qr',
    title: 'QR Generado',
    description: 'Ticket QR: 4567 - Válido hasta 14:45',
    status: 'completed',
  },
  {
    id: 3,
    ...
    type: 'cycle',
    title: 'Nuevo Ciclo Bimensual',
    description: 'Ciclo 2024-06 iniciado - Beneficio Premium asignado',
    status: 'completed',
  },
  {
    id: 4,
    date: '2024-11-12 16:45',
    type: 'delivery',
    title: 'Retiro Realizado',
    description: 'Caja Premium entregada - Código QR: 3421',
    guard: 'María Castro',
    status: 'completed',
  },
  {
